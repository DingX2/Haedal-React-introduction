    ...
    <div className="footer">
      <div className='footer_intro'>
        <div className='footer_haedal'>
          ...
          <div className='footer_haedal_desc'><span>경북대학교 IT대학 학술동아리</span></div>
        </div>
        <div className='footer_links'>
          <img src='img/insta.png' alt='instagram'
            onClick={() => window.open('https://www.instagram.com/knu.haedal/', '_blank')}
          />
          <img src='img/notion.png' alt='notion'
            onClick={() => window.open('https://encouraging-hawk-156.notion.site/092c37464b6946d7a9290eef1d78b2fa', '_blank')}
          />
        </div>
      </div>
      ...
      <div className='footer_madeBy'>
        <span>Made By</span>
        <ul>
          <li><span>김은정 김아진 이수현</span></li>
          <li><span>OOO OOO OOO</span></li>
        </ul>
      </div>
